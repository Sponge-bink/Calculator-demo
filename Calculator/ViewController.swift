...
class ViewController: UIViewController {
    ...
    func addComma(for numberStoredInString: String, isInt: Bool) -> String {
        // for adding "," by the index generated by var commaIndex in Extension for Int
        var stringToReturn = numberStoredInString
        if isInt, Int(numberStoredInString)!.commaIndex != nil {
            for indexes in Int(numberStoredInString)!.commaIndex!.reversed() {
            ...
            if let indexOfTheDecimalPoint = numberStoredInString.index(of: ".") {
                let theDecimalPointAndStringAfterIt: String.SubSequence? = numberStoredInString[indexOfTheDecimalPoint...]
                return addComma(for: String(Int(Double(numberStoredInString)!)), isInt: true) + String(theDecimalPointAndStringAfterIt!)
    ...
    var stringOnScreen: String? = "0" {
        didSet {
            if abs(numberOnScreen) > Double(Int.max) {
                clear()
